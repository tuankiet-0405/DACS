...
document.addEventListener('DOMContentLoaded', function() {
    ...
    form.addEventListener('submit', async function(e) {
        ...
        // Recopilar y validar datos obligatorios
        ...
        for (const field of requiredFields) {
            ...
            if (!element || !element.value || element.value.trim() === '') {
                ...
                console.log(`Campo ${field}: ${element.value.trim()}`);
            }
        }
        ...
        formData.append('type', 'self-drive');  // Tipo fijo para esta página
        ...
        try {
            ...
            console.log('Đang gửi request đến server với path: /api/cars');
            console.log('FormData fields:', [...formData.entries()].map(e => e[0]).join(', '));
            ...
            if (response.data.success) {
                ...
                Swal.fire({
                    ...
                    html: `
                        ...
                        ${notifyResult && notifyResult.offline ? 
                        `<p style="font-size: 0.9rem; margin-top: 12px; background-color: #fff8e6; padding: 8px; border-radius: 4px; color: #b45309;">
                            <i class="fas fa-exclamation-triangle" style="color: #d97706;"></i> 
                            Thông báo đã được lưu offline và sẽ tự động gửi cho admin khi có kết nối internet.
                        </p>` : ''}
                    `,
                  ...
                  // Gửi thông báo đến admin với hỗ trợ offline
                try {
                    ...
                    console.log('Đang chuẩn bị gửi thông báo đến admin (có hỗ trợ offline)');
                    ...
                    // Sử dụng hàm sendNotificationWithOfflineSupport thay vì gọi API trực tiếp
                    // Hàm này sẽ tự động xử lý việc lưu thông báo offline nếu không có kết nối
                    ...
                    // Nếu có lỗi khi gửi thông báo, vẫn đảm bảo người dùng được thông báo đăng ký xe thành công
                }
            } else {
