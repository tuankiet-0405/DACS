    ...
    createNotification: async (req, res) => {
        try {
            ...
            const newNotification = await db.query(
                `INSERT INTO thong_bao (tieu_de, noi_dung, loai_thong_bao, lien_ket, nguoi_gui_id, nguoi_nhan_id, da_doc, ngay_tao)
                VALUES ($1, $2, $3, $4, $5, $6, false, CURRENT_TIMESTAMP)
                RETURNING *`,
                [tieu_de, noi_dung, loai_thong_bao || null, lien_ket || null, req.user.id, nguoi_nhan_id || null]
            );
    ...
    getAdminNotifications: async (req, res) => {
        try {
            ...
            const notifications = await db.query(
                ...
                FROM thong_bao n
                LEFT JOIN nguoi_dung u ON n.nguoi_gui_id = u.id
