...
const NotificationController = {
    ...
    createNotification: async (req, res) => {
        try {
            const { tieu_de, noi_dung, loai, url, nguoi_nhan_id } = req.body;
            ...
            const newNotification = await db.query(
                `INSERT INTO thong_bao (tieu_de, noi_dung, loai, url, nguoi_dung_id, nguoi_nhan_id, da_doc, ngay_tao)
                VALUES ($1, $2, $3, $4, $5, $6, false, CURRENT_TIMESTAMP)
                RETURNING *`,
                [tieu_de, noi_dung, loai, url || null, req.user.id, nguoi_nhan_id || null]
            );
